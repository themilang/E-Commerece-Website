...
import headimg from '../../../assets/index'
              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-black pb-12 shadow-xl">
                    ...
                    <Tab.List className="-mb-px flex space-x-8 px-4 ">
                      {navigation.categories.map((category) => (
                        <Tab
                          ...
                          className={({ selected }) =>
                            classNames(
                              selected ? 'border-white   text-[#376bdc]' : 'border-transparent text-white',
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    ...
                    />
                    <span className="ml-3 block text-base font-medium text-white">CAD</span>
        ...
        <nav aria-label="Top" className=" bg-black mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
          <div className="">
            <div className="flex h-16 items-center">
              <button
                type="button"
                className="relative rounded-md bg-dark p-2 text-white lg:hidden"
                ...
                <div className="flex h-full space-x-8">
                            ...
                            <Popover.Button
                              className={classNames(
                                open
                                  ...
                                  : 'border-transparent text-[#e7e7e7] hover:text-white',
                                          ...
                                          >
                                            {section.items.map((item) => (
                                              <li key={item.name} className="flex">
                                                <a href={item.href} className="hover:text-[#ffff]">
                                                  {item.name}
                                                </a>
                                              </li>
                                            ))}
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-sm font-medium text-[#d3d3d3] hover:text-[#ffff]"
                    >
                      {page.name}
                    </a>
                  ))}
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a href="#" className="text-sm font-medium text-[#ffff] hover:text-[#ffff]">
                    Sign in
                  </a>
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-[#ffff] hover:text-[#ffff]">
                    <img
                      src="https://tailwindui.com/img/flags/flag-canada.svg"
                      alt=""
                      className="block h-auto w-5 flex-shrink-0"
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <a href="#" className="group -m-2 flex items-center p-2">
                    ...
                    />
                    <span className="ml-2 text-sm font-medium text-[#ffff] group-hover:text-[#ffff]">0</span>
